...
<div class="container">
    ...
    <div class="checkout-form">
        <h4 class="text-center mb-4">Checkout Form</h4>
        <form id="checkout-form">
            ...
            <button id="payment-button" type="button" class="payment-button btn btn-primary" disabled><i class="fas fa-money-check-alt"></i> Pay with Khalti</button>
        </form>
