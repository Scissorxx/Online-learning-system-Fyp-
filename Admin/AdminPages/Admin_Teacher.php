			...
			<table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM userdetail WHERE user_type='Teacher'";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>
                                                ...
                                                <a href='#' class='delete' data-student-name='" . $row['fullname'] . "' data-student-id='" . $row['SN'] . "'><i class='material-icons' data-toggle='tooltip' title='Delete'>&#xE872;</i></a>                        
                                             <a href='view_teacher.php?id=" . $row['SN'] . "' class='view'><i class='material-icons' data-toggle='tooltip' title='View'>&#xE417;</i></a>
                                              </td>";
                                        echo "</tr>";
                                    }
                                } else {
